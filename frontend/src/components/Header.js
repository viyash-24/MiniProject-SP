...
const Header = () => {
  ...
  return (
    <nav className="bg-white/80 dark:bg-slate-900/80 backdrop-blur border-b border-gray-200 dark:border-slate-800 sticky top-0 z-40 shadow-sm transition-colors">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {!user ? (
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {profileDropdown && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 rounded-md shadow-lg border border-gray-200 dark:border-slate-700 py-1 z-50">
      ...
      {open && (
        <div className="md:hidden border-t border-gray-200 bg-white/95 dark:bg-slate-900/95 backdrop-blur">
