    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About Smart Parking</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
          <div className="prose max-w-none">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">What We Do</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-6">
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <p className="text-gray-600">Find parking in seconds with our real-time availability system</p>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <p className="text-gray-600">All transactions are encrypted and processed securely</p>
              </div>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">Our Vision</h2>
            <p className="text-gray-700 mb-6">
