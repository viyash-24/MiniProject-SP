  ...
  return (
    <div className="min-h-[70vh] grid place-items-center bg-gradient-to-br from-blue-50 via-white to-blue-100 px-4 py-12">
      <div className="w-full max-w-md bg-white border shadow-xl rounded-2xl p-8">
        ...
        <button
          onClick={onGoogle}
          className="mt-6 w-full inline-flex items-center justify-center gap-2 border rounded-md py-2.5 hover:bg-gray-50"
        >
          <img
            alt="Google"
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="mt-1 w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring-blue-500 pr-10 py-2 px-3"
              placeholder="••••••••"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-primary hover:bg-primary-dark text-white rounded-md font-medium disabled:opacity-60"
          >
